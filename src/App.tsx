  ...
  if (loading) {
    return (
      <div style={styles.page}>
        <style>{globalCss}/* E014D_BUTTON_REGISTRAR_EVIDENCIA_INLINE */
/* E014E_REZGO_LOGO_HEADER */

/* E014D: Registrar evidencia button aligned like Entrada/Salida buttons */
.e014dEvidenceActionBtn {
...
.e014dEvidenceActionBtn svg { flex: 0 0 auto; }
